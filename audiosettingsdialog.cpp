// audio_settings_dialog.cpp
//
// Edit an AudioSettings object.
//
//   (C) Copyright 2002-2003 Fred Gleason <fredg@paravelsystems.com>
//
//    $Id: audiosettingsdialog.cpp,v 1.2 2008/09/06 12:02:46 fredg Exp $
//
...
void AudioSettingsDialog::ShowBitRates(AudioSettings::Format fmt,int rate)
{
...
AudioSettings::Format AudioSettingsDialog::ReadFormat()
{
  if(lib_format_box->currentText()==tr("PCM16")) {
    return AudioSettings::Pcm16;
  }
  if(lib_format_box->currentText()==tr("OggVorbis")) {
    return AudioSettings::OggVorbis;
  }
  if(lib_format_box->currentText()==tr("MPEG Layer 2")) {
    return AudioSettings::Layer2;
  }
